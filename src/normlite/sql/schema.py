...
class Column(HasIdentifier, ColumnElement, ColumnOperators):
    ...
    def __init__(self, name: str, type_: TypeEngine, id_: str = None, primary_key: bool = False):
        ...
        self.type_ = type_
        """The column type as a concrete subclass of :class:`normlite.sql.type_api.TypeEngine`."""
        ...
        """Comparator for column expressions.
        
        :class:`Column` injects at runtime the comparator using the :attr:`normlite.sql.type_api.TypeEngine.comparator_factory` 
        class attribute to instantiate the right typed comparator.
